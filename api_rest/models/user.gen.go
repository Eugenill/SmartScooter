...
type User struct {
	...
	ContactEmail string         `json:"contact_email" bunny:"contact_email" `
...
var (
	userColumns              = []string{"id", "login", "secret_hash", "contact_email", "is_deleted", "deleted_at"}
	userPrimaryKeyColumns    = []string{"id"}
	userNonPrimaryKeyColumns = []string{"login", "secret_hash", "contact_email", "is_deleted", "deleted_at"}
)
