...
net = cv2.dnn.readNetFromTensorflow("../../TL_W_COLORS/new_models/TL_v5.4/frozen_inference_graph.pb", "../../TL_W_COLORS/new_models/TL_v5.4/graph.pbtxt")
...
while True:
	...
	for i in np.arange(0, detections.shape[2]):
		...
		if confidence > args["confidence"]:
			...
			ret = client.publish("traffic_lights",label)
			client.loop()
