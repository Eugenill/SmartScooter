#!/usr/bin/env python
"""
 USAGE: python3 async_prediction.py -m ../TL_W_COLORS/new_models/TL_v5/OPENVINO/frozen_inference_graph.xml -i video.mp4
...
def build_argparser():
    ...
    args.add_argument("-m", "--model", help="Required. Path to an .xml file with a trained model.",
                      default="IR10/frozen_inference_graph.xml", type=str)
...
def main():
    ...
    while cap.isOpened():
        ...
        if not args.no_show:
            cv2.imshow("Detection Results", cv2.cvtColor(frame, cv2.COLOR_RGB2BGR))
